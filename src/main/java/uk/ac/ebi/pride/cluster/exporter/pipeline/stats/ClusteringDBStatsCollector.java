package uk.ac.ebi.pride.cluster.exporter.pipeline.stats;
...
//        // create data source
//        ClusterRepositoryServices clusterRepositoryBuilder = new ClusterRepositoryServices("prop/cluster-database-oracle.properties");
//
...
//
//        // create cluster services statistics writer
...
//                    statistics.add(new ClusterRepoStatistics(ClusterRepoStatistics.OVERLAPPING_UNIQUE_PEPTIDES_ON_SPECIES + "|" + species + "|" + speciesToCompare, (long) intersection));
//                }
//            }
//        }
//        clusterRepoStatisticsWriter.saveStatistics(statistics);
